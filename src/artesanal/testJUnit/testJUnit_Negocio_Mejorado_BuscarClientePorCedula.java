...
public class testJUnit_Negocio_Mejorado_BuscarClientePorCedula {
	...
	void buscarCliente_RetornoCliente() {
		...
		assertEquals(cliente1, taberna.buscarClientePorCedula("123467"));
		assertEquals(cliente2, taberna.buscarClientePorCedula("098782"));
	}
}
